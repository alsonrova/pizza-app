...
export const ingrediants = {
    ...
    bolognaise : { name: 'Bolognaise', price: 1.3 ,type:"meat" ,image:"bolognaise.svg"} as Ingrediant,
    chorizo : { name: 'Chorizo', price: 1.3 ,type:"meat" ,image:"chorizo.svg"} as Ingrediant,
    pancetta : { name: 'Pancetta', price: 2.0 ,type:"meat" ,image:"pancetta.svg"} as Ingrediant,
    mushroom : { name: 'Champignon de Paris', price: 1.0 ,type:"vegetables",image:"mushroom.svg"} as Ingrediant,
