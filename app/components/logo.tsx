  ...
  return (
    <div className="flex w-full items-center h-40 flex-col">
        <div className='flex items-center h-10 mb-1'>
            <Image className="w-16 translate-x-1" src="/assets/floraldecoration.png" alt="Logo" />
            <p className='text-xs italic'>Since 1956</p>
            <Image className="w-16 transform -scale-x-100 -translate-x-1" src="/assets/floraldecoration.png" alt="Logo" />
        </div>
